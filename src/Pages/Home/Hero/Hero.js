        ...
        <div className=' mb-10 hero'>
            ...
            <div className='text-center z-10 relative  py-8 '>
                ...
                <div className='flex justify-center'>
                    <img className='w-96 mb-10' src='https://i.ibb.co/1fZSbcb/portofolio-image-min.png' alt="" />
                </div>
            </div>
            <div className='backdrop-blur-lg   box-shadow  bg-gradient-to-r md:bg-gradient-to-t from-fuchsia-800 to-blue-800 md:w-10 w-72 h-12 md:h-72 absolute left-0 md:left-0 bottom-0 md:top-40 rounded-r-lg'>
                ...
                <div className="flex flex-row md:flex-col gap-x-5 items-center gap-y-0 md:gap-y-5 justify-center">
                    ...
                    <a target={'_blank'} rel="noreferrer" href="https://github.com/itsmiraz" title="Github" className="flex items-center justify-center  rounded-full sm:w-10 sm:h-10  text-gray-100">
                        <FaGithub className='w-6 h-6'></FaGithub>
                    </a>
                    <a target={'_blank'} rel="noreferrer" href="https://www.facebook.com/Iammirajhossen" title="Facebook" className="flex items-center justify-center  rounded-full sm:w-10 sm:h-10  text-gray-100">
                    ...
                    <a target={'_blank'} rel="noreferrer" href="https://www.instagram.com/its_miraz_/" title="Instagram" className="flex items-center justify-center  rounded-full sm:w-10 sm:h-10  text-gray-100">
                    ...
                    <a target={'_blank'} rel="noreferrer" href="https://twitter.com/iammirajhossen" title="Twitter" className="flex items-center justify-center rounded-full sm:w-10 sm:h-10  text-gray-100">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" className="w-6 h-6">
