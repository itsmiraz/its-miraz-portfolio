                ...
                <div className="container flex flex-col p-4 mx-auto md:p-8 lg:flex-row divide-gray-400">
                    ...
                    <div className="flex flex-col justify-center pt-6 lg:pt-0">
                        <div className="flex justify-center space-x-4">
                            <a rel="r" href="/" title="Twitter" className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-cyan-500 text-gray-800">
                                <FaLinkedin></FaLinkedin>
                            </a>
                            <a rel="r" href="/" title="Twitter" className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-cyan-500 text-gray-800">
                                <FaGithub></FaGithub>
                            </a>
                            <a rel="r" href="/" title="Facebook" className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-cyan-500 text-gray-800">
                            ...
                            <a rel="r" href="/" title="Instagram" className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-cyan-500 text-gray-800">
